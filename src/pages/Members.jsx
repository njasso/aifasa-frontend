...
// Il est utilisé pour les confirmations de suppression.
      ...
      <div className="bg-white p-6 rounded-lg shadow-xl text-center max-w-sm mx-auto">
        ...
        <div className="flex justify-center gap-4 mt-6">
          {showConfirm && (
            <button
              onClick={onConfirm}
              className="px-4 py-2 bg-emerald-600 text-white rounded-lg shadow-md hover:bg-emerald-700 transition duration-300"
            >
              Confirmer
            </button>
          )}
...
const Members = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    cvFile: null, // État pour le fichier CV
    cvFileName: '' // État pour le nom du fichier CV
  });
  ...
  const handleEdit = (member) => {
    setFormData({
      ...member,
      // Réinitialiser les entrées de fichiers pour éviter les problèmes de sécurité/état
      profilePicture: null,
      cvFile: null,
    });
