...
const Home = () => {
  ...
  const activities = [
    ...
    { id: 3, title: "Assemblé Générale", description: "Renontre trimestrielle de L'AG à Kribi.", date: "12 Juillet 2025" },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            >
              ...
              <div className="flex justify-center space-x-4">
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-800">
                  <i className="fab fa-facebook text-xl"></i>
                </a>
                <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-800">
                  <i className="fab fa-twitter text-xl"></i>
                </a>
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-800">
